 ...
 * @seit 2.6.0
 */
define('AUTH_KEY',         '0Ha]E9[D(Ck0PXp[<l#==lx!U)3Enymb]FM(fx#{BVB][D r*]JD?x3>8qS;^(-x');
define('SECURE_AUTH_KEY',  'IG$,;2]v)Fx)]3K-I$jArSbfi:&vxjV_(of8Z5-r_EH>eU:1k$}2Wh-iX3hl]Tg)');
define('LOGGED_IN_KEY',    'QV.wdM-W-2QN%8}KQe~wqe]MCn-s=eXyBp`rZ|o3%o&+@$o/|gUkbnPIfqTNei|t');
define('NONCE_KEY',        'w6yjw69+WU7;iI8-+NTL|q|kH>|/]lg ?[-$r-+{e_6|P_o;oz+WzD?A2V~.4}Z ');
define('AUTH_SALT',        '1Tw|-{AikE}s?|X25X|KU.]p6zh)12u.uZZ.w)T@0~]Iz&-2/lAEnqj_Hh4L KC`');
define('SECURE_AUTH_SALT', 'KO=:-zL)/5vNLcmnquG._|-a(I&tr*tG=@er4Qh;Wo1jRTb}QDgB61F&b19sh4@E');
define('LOGGED_IN_SALT',   'dT3|=>,6PkSh-d!PDr[$(qoD{.7IoTYVNggo%-b*>Ism|&L)id3G(G(f6,/lv?Kb');
define('NONCE_SALT',       'mRNR&h*}=ufX>91$YuJvr&:X,iK/|`~hPo`|1KvmT:RW_#8xp}uL,i*$_!v/cM:w');
